...
/**
 * REST controller for managing {@link br.com.rnati.pageboard.domain.Pessoa}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PessoaResource {
                ...
                Mono<Pessoa> result = pessoaRepository
                    ...
                    .map(existingPessoa -> {
                        ...
                        if (pessoa.getDataDeNascimento() != null) {
                            existingPessoa.setDataDeNascimento(pessoa.getDataDeNascimento());
                        }
     ...
     */
    @GetMapping("/pessoas")
    public Mono<List<Pessoa>> getAllPessoas() {
        log.debug("REST request to get all Pessoas");
        return pessoaRepository.findAll().collectList();
    }
